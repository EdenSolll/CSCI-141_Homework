...
def readWordFile(filename: str) -> dict[str, dict[int, int]]:
    ...
    Then the program assigns those key, value pairs to the last used word. Finally the programm merges a default dictionary with the words dictionary to account for any missing year data.
